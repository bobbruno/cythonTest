/* Generated by Cython 0.20.1post0 (Debian 0.20.1+git90-g0e6e38e-1ubuntu2) on Sun Aug 31 18:45:22 2014 */
...
static int __pyx_f_6mandel_cmandel(float, float, int); /*proto*/
...
static PyObject *__pyx_pf_6mandel_ccreate_fractal(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_Nx, int __pyx_v_Ny, int __pyx_v_xmin, int __pyx_v_xmax, int __pyx_v_ymin, int __pyx_v_ymax, int __pyx_v_max_iter); /* proto */
...
static char __pyx_k_ipart[] = "ipart";
static char __pyx_k_numpy[] = "numpy";
static char __pyx_k_range[] = "range";
static char __pyx_k_rpart[] = "rpart";
...
static char __pyx_k_ccreate_fractal[] = "ccreate_fractal";
...
static char __pyx_k_home_bobbruno_Downloads_DSR_pyt[] = "/home/bobbruno/Downloads/DSR/python/dsr-fall-2014/intro-to-scientific-computing-with-python/notebooks/mandel.pyx";
...
static PyObject *__pyx_n_s_ccreate_fractal;
...
static PyObject *__pyx_kp_s_home_bobbruno_Downloads_DSR_pyt;
...
static PyObject *__pyx_n_s_rpart;
...
static int __pyx_f_6mandel_cmandel(float __pyx_v_x, float __pyx_v_y, int __pyx_v_max_iter) {
  float __pyx_v_cx;
  float __pyx_v_cy;
  float __pyx_v_zx;
  float __pyx_v_zy;
  ...
  float __pyx_t_4;
  int __pyx_t_5;
  __Pyx_RefNannySetupContext("cmandel", 0);
 ...
 *         if (zx*zx + zy*zy) >= 4:
 */
    ((((__pyx_v_zx * __pyx_v_zx) + (__pyx_v_zx * __pyx_v_zy)) + (__pyx_v_zy * __pyx_v_zx)) - (__pyx_v_zy * __pyx_v_zy));
 ...
 *             return i
 */
    __pyx_t_3 = (((__pyx_v_zx * __pyx_v_zx) - (__pyx_v_zy * __pyx_v_zy)) + __pyx_v_cx);
    __pyx_t_4 = (((__pyx_v_zx * __pyx_v_zy) + (__pyx_v_zy * __pyx_v_zx)) + __pyx_v_cy);
    __pyx_v_zx = __pyx_t_3;
    __pyx_v_zy = __pyx_t_4;
 ...
 * 
 */
    __pyx_t_5 = ((((__pyx_v_zx * __pyx_v_zx) + (__pyx_v_zy * __pyx_v_zy)) >= 4.0) != 0);
    if (__pyx_t_5) {
...
/* Python wrapper */
static PyObject *__pyx_pw_6mandel_1ccreate_fractal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6mandel_ccreate_fractal[] = "Create and return a fractal image";
static PyMethodDef __pyx_mdef_6mandel_1ccreate_fractal = {__Pyx_NAMESTR("ccreate_fractal"), (PyCFunction)__pyx_pw_6mandel_1ccreate_fractal, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_6mandel_ccreate_fractal)};
static PyObject *__pyx_pw_6mandel_1ccreate_fractal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_Nx;
  int __pyx_v_Ny;
  int __pyx_v_xmin;
  int __pyx_v_xmax;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("ccreate_fractal (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_Nx,&__pyx_n_s_Ny,&__pyx_n_s_xmin,&__pyx_n_s_xmax,&__pyx_n_s_ymin,&__pyx_n_s_ymax,&__pyx_n_s_max_iter,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Ny)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("ccreate_fractal", 1, 7, 7, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_xmin)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ccreate_fractal", 1, 7, 7, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_xmax)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ccreate_fractal", 1, 7, 7, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ymin)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ccreate_fractal", 1, 7, 7, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ymax)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ccreate_fractal", 1, 7, 7, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_iter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ccreate_fractal", 1, 7, 7, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "ccreate_fractal") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_Nx = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_Nx == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_Ny = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_Ny == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_xmin = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_xmin == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_xmax = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_xmax == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ymin = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_ymin == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ymax = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_ymax == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  __Pyx_RaiseArgtupleInvalid("ccreate_fractal", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("mandel.ccreate_fractal", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6mandel_ccreate_fractal(__pyx_self, __pyx_v_Nx, __pyx_v_Ny, __pyx_v_xmin, __pyx_v_xmax, __pyx_v_ymin, __pyx_v_ymax, __pyx_v_max_iter);
...
static PyObject *__pyx_pf_6mandel_ccreate_fractal(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_Nx, int __pyx_v_Ny, int __pyx_v_xmin, int __pyx_v_xmax, int __pyx_v_ymin, int __pyx_v_ymax, int __pyx_v_max_iter) {
  int __pyx_v_x;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("ccreate_fractal", 0);
 ...
 *     """Create and return a fractal image"""
 *     cdef int x
 *     cdef np.ndarray[float_t, ndim=2] image = np.zeros((Ny, Nx), dtype=float)             # <<<<<<<<<<<<<<
 *     cdef float dx
 *     cdef float dy
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_Ny); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_Nx); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_image.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 * 
 */
  __pyx_t_6 = ((__pyx_v_xmax - __pyx_v_xmin) * 1.);
 ...
 *     for x in range(Nx):
 */
  __pyx_t_6 = ((__pyx_v_ymax - __pyx_v_ymin) * 1.);
 ...
 *             ipart = ymin + y * dy
 */
    __pyx_v_rpart = (__pyx_v_xmin + (__pyx_v_x * __pyx_v_dx));
 ...
 *             image[y, x] = color
 */
      __pyx_v_ipart = (__pyx_v_ymin + (__pyx_v_y * __pyx_v_dy));
 ...
 *     return image
 */
      __pyx_v_color = __pyx_f_6mandel_cmandel(__pyx_v_rpart, __pyx_v_ipart, __pyx_v_max_iter);
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_image.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_image.diminfo[0].strides, __pyx_t_12, __pyx_pybuffernd_image.diminfo[1].strides) = __pyx_v_color;
    }
  }
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_ccreate_fractal, __pyx_k_ccreate_fractal, sizeof(__pyx_k_ccreate_fractal), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_home_bobbruno_Downloads_DSR_pyt, __pyx_k_home_bobbruno_Downloads_DSR_pyt, sizeof(__pyx_k_home_bobbruno_Downloads_DSR_pyt), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_rpart, __pyx_k_rpart, sizeof(__pyx_k_rpart), 0, 0, 1, 1},
 ...
 *     cdef int x
 */
  __pyx_tuple__8 = PyTuple_Pack(15, __pyx_n_s_Nx, __pyx_n_s_Ny, __pyx_n_s_xmin, __pyx_n_s_xmax, __pyx_n_s_ymin, __pyx_n_s_ymax, __pyx_n_s_max_iter, __pyx_n_s_x, __pyx_n_s_image, __pyx_n_s_dx, __pyx_n_s_dy, __pyx_n_s_rpart, __pyx_n_s_ipart, __pyx_n_s_y, __pyx_n_s_color); if (unlikely(!__pyx_tuple__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(7, 0, 15, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_bobbruno_Downloads_DSR_pyt, __pyx_n_s_ccreate_fractal, 30, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_tuple__10 = PyTuple_Pack(7, __pyx_int_800, __pyx_int_600, __pyx_int_neg_2, __pyx_int_1, __pyx_int_neg_1, __pyx_int_1, __pyx_int_20); if (unlikely(!__pyx_tuple__10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static int __Pyx_InitGlobals(void) {
  ...
  __pyx_int_600 = PyInt_FromLong(600); if (unlikely(!__pyx_int_600)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("mandel"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "mandel")) {
      if (unlikely(PyDict_SetItemString(modules, "mandel", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int x
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_6mandel_1ccreate_fractal, NULL, __pyx_n_s_mandel); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_ccreate_fractal, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * plt.imshow(image, cmap=plt.cm.jet)
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_ccreate_fractal); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__10, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_image, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * plt.imshow(image, cmap=plt.cm.jet)             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_plt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_imshow); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_image); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_plt); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_cm); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_jet); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_cmap, __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
